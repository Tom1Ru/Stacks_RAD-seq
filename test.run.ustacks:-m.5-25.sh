...
#denovo_map.pl -M 5 -T 30 -S -b 0 -X "populations:--write_single_snp -R 0.3 --vcf --phylip --phylip-var --fasta-loci --genepop" -X "ustacks:-m 10" -O ./popmap.Flash.txt --samples ./raw -o stacks_10
#denovo_map.pl -M 5 -T 30 -S -b 0 -X "populations:--write_single_snp -R 0.3 --vcf --phylip --phylip-var --fasta-loci --genepop" -X "ustacks:-m 15" -O ./popmap.Flash.txt --samples ./raw -o stacks_11
#denovo_map.pl -M 5 -T 30 -S -b 0 -X "populations:--write_single_snp -R 0.3 --vcf --phylip --phylip-var --fasta-loci --genepop" -X "ustacks:-m 20" -O ./popmap.Flash.txt --samples ./raw -o stacks_12
#denovo_map.pl -M 5 -T 30 -S -b 0 -X "populations:--write_single_snp -R 0.3 --vcf --phylip --phylip-var --fasta-loci --genepop" -X "ustacks:-m 25" -O ./popmap.Flash.txt --samples ./raw -o stacks_13
